...
a.dx/a.dy,l=g.dx>0,o=a.dx<0;for(e=e;e<d;e++){var u=f*Math.max(0,Math.min(g.dy,e+l-g.y0))+g.x0;c(Math.floor(i*Math.max(0,Math.min(a.dy,e+o-a.y0))+a.x0),Math.ceil(u),e)}}function $(g,a,e,d,c,f){var i=U(g,a);a=U(a,e);g=U(e,g);if(i.dy>a.dy){e=i;i=a;a=e}if(i.dy>g.dy){e=i;i=g;g=e}if(a.dy>g.dy){e=a;a=g;g=e}i.dy&&Z(g,i,d,c,f);a.dy&&Z(g,a,d,c,f)}r.version="2.0.2+2";var R={x:0,y:0};r.id=function(){var g=0;return function(){return++g}}();r.svg=function(g){return document.createElementNS(r.ns.svg,g)};r.ns={svg:"http://www.w3.org/2000/svg",
